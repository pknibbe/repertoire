    ...
    <form action="UpdateAccounts" method="POST">
        <table>
            ...
            <c:forEach var="person" items="${users}">
                <tr>
                    <td><input type="radio" name="userID" id=${person.id} value=${person.id} /></td>
                    <td>${person.id}</td>
                    <td>${person.name}</td>
            ...
            <tr>
                <td>UserId: <input type="radio" name="userID" value="0" /></td>
                <td>New User</td>
                <td>Name: <input type="text" name="Name" value="" /></td>
                <td>Username: <input type="text" name="Username" value="" /></td>
                <td>Username: <input type="text" name="Password" value="" /></td>
