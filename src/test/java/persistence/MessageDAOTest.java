...
public class MessageDAOTest {
    ...
    private int originalNumberOfMessages;
        ...
        public void setup() throws Exception {
            ...
            newMessageID = dao.create(message);
    ...
    public void testGetAllForRecipient() throws Exception {
        ...
        for (entity.Message message : dao.getAll(user.getId())) {
            String thisName = message.getSubject();
            if (thisName.equalsIgnoreCase("Election")) found = true;
        }
        assertTrue("The expected subject was not found: ", found);
        ...
        public void testGet() throws Exception {
            assertEquals("Subjects don't match", "Election", dao.read(newMessageID).getSubject());
        }

        @After
        public void cleanup() throws Exception {
            dao.delete(dao.read(newMessageID));
            numberOfMessages = dao.getAll().size();
